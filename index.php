    ...
    <head>
    <meta charset="utf-8">
    <title>Randall Mullins | Portfolio</title>
    ...
    @media (max-width: 768px)  {
      .header-text-wrap, .header-img-wrap{text-align:center;}
    }
    @media (min-width: 769px) {
      .header-text-wrap{text-align:left;}
      .header-img-wrap{text-align:right;}
      .header-img-wrap img {margin-right:40px;}
      ...
      <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
          <div class="container">
            ...
            <h1 class="brand"><a href="#top">Randall Mullins</a></h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="span8 header-text-wrap">
             ...
             <ul class="icon">
                <li><a href="https://www.linkedin.com/in/randallmullins/" target="_blank"><i class="icon-linkedin-circled"></i><span class="icon-text">Connect on LinkedIn</span></a></li>
              </ul>
            </div>
          </div>
      ...
      <section id="feature">
        <div class="container">
          <div class="row">
            <div class="span12">
              <article>
                <p>"Imagination is the last legal means of gaining an unfair advantage over the competition." - Juicing the Orange</p>
              </article>
            </div>
          </div>
        </div>
   ...
   <!--  <section id="news" class="single-page scrollblock">
    ...
    <section id="team" class="single-page scrollblock">
      <div class="container">
        ...
        <div class="row">
          <div class="span12">
            <div class="teamalign"> <img class="team-thumb img-circle" src="img/RandallMullins2.png" alt=""> </div>
        <!--     <h3>Randy</h3>
      ...
      <div class="container">
        ...
        <h1>Contact Info</h1>
         ...
         <div class="row">
          <div class="span10 offset1">
            <div class="featurette">
              <h2 class="featurette-heading">Randall Mullins</h2>
              <h2 class="featurette-heading">Phone: <span class="muted"> 614.432.9323</span></h2>
              <h2 class="featurette-heading">Email: <span class="muted"> randall.mullins@gmail.com</span></h2>
              <h2 class="featurette-heading">Address:<br /> <span class="muted">234 Cantwell Ct.<br />Reynoldsburg, OH 43068</span></h2>
...
<!-- 
        ...
        <div class="row">
          <div class="span6">
            <h3>Randall Mullins</h3>
            <h4>p: 614-432-9323</h4>
            <h4>e: randall.mullins@gmail.com</h4>
          </div>
        </div>
 -->
           ...
           <!--  <div class="cform" id="theme-form">
              <form action="#" method="post" class="cform-form">
                ...
                <div class="row">
                  <div class="span12"> <span class="your-email">
    ...
    <div class="footer-wrapper">
      <div class="container">
        <footer>
          <small>Randall Mullins &nbsp;&nbsp;|&nbsp;&nbsp; randall.mullins@gmail.com &nbsp;&nbsp;|&nbsp;&nbsp; 234 Cantwell Ct. &nbsp;&nbsp;|&nbsp;&nbsp; Reynoldsburg, OH 43068</small>
        </footer>
      </div>
      <!-- ./container -->
    </div>
